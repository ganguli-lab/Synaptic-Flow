...
class VGG16_CIFAR10(nn.Module):
    def __init__(self, input_c = 3, num_classes = 10):
        ...
        self.conv4_2 = l.Conv2d(128, 128, kernel_size=3, padding=0)  # 10
        self.bn4_2 = nn.BatchNorm2d(128)
        
        self.conv4_3 = l.Conv2d(128, 128, kernel_size=3, padding=0)  # 8
...
def _vgg(arch, num_classes, dense_classifier, pretrained):
    ...
    if pretrained:
        if num_classes == 10:
            pretrained_path = 'Models/models/new/' + 'vgg16_10_ori_relu_small.pth'
