...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, option='A'):
        ...
        self.shortcut = layers.Identity2d(in_planes)
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_channels, num_classes, dense_classifier):
        super(ResNet, self).__init__()
        self.in_planes = 16

        self.conv1 = layers.Conv2d(num_channels, 16, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn1 = layers.BatchNorm2d(16)
...
def resnet_factory(filters, file):
    def _resnet(input_shape, num_classes, dense_classifier=False, pretrained=False):
        num_channels, _, _ = input_shape
...
resnet20 = resnet_factory([3, 3, 3], 'shrinkbench-resnet20.th')
resnet32 = resnet_factory([5, 5, 5], 'shrinkbench-resnet32.th')
resnet44 = resnet_factory([7, 7, 7], 'shrinkbench-resnet44.th')
resnet56 = resnet_factory([9, 9, 9], 'shrinkbench-resnet56.th')
resnet110 = resnet_factory([18, 18, 18], 'shrinkbench-resnet110.th')
resnet1202 = resnet_factory([200, 200, 200], 'shrinkbench-resnet1202.th')
